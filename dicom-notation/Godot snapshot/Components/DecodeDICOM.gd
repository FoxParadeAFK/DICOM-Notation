...
func _ready() -> void:
	...
	var imageData : FileAccess = FileAccess.open("res://Godot snapshot/Parsed Data/1-01.raw", FileAccess.READ)
	...
	mriImage.save_png("res://Godot snapshot/Parsed Data/1-01.png")