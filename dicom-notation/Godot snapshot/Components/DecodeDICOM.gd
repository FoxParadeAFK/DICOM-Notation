...
func _ready() -> void:
	...
	var fileData : String = JSON.stringify(valueInformation, "\t", false)

	var file = FileAccess.open("res://Godot snapshot/Parsed Data/1-01.json", FileAccess.WRITE)
